This is a configurable discord bot that uses Hugging Face's Inference Endpoint API to interact with queries sent to a Open Source LLM bu a discord user.
